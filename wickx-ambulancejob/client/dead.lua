    ...
    if event == 'CEventNetworkEntityDamage' then
        ...
        if victimDied and NetworkGetPlayerIndexFromPed(victim) == PlayerId() and IsEntityDead(PlayerPedId()) then
            ...
            elseif InLaststand and not isDead then
                ...
                local weaponLabel = (WKXCore.Shared.Weapons and WKXCore.Shared.Weapons[weapon] and WKXCore.Shared.Weapons[weapon].label) or 'Unknown'
                local weaponName = (WKXCore.Shared.Weapons and WKXCore.Shared.Weapons[weapon] and WKXCore.Shared.Weapons[weapon].name) or 'Unknown'
                TriggerServerEvent('wickx-log:server:CreateLog', 'death', Lang:t('logs.death_log_title', { playername = playerName, playerid = GetPlayerServerId(playerid) }), 'red', Lang:t('logs.death_log_message', { killername = killerName, playername = playerName, weaponlabel = weaponLabel, weaponname = weaponName }))
