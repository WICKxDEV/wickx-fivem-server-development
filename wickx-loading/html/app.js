...
const load = Vue.createApp({
  setup () {
    return {
      ...
      CarouselText2: 'Adding additional player data can be achieved by modifying the wickx-core player.lua file.',
      ...
      CarouselText4: 'For additional support please join our community at discord.gg/wickxcore',
      CarouselSubText4: 'Photo captured by: Robinerino#1312',

      DownloadTitle: 'Downloading WKXCore Server',
      DownloadDesc: "Hold tight while we begin downloading all the resources/assets required to play on WKXCore Server. \n\nAfter download has been finished successfully, you'll be placed into the server and this screen will disappear. Please don't leave or turn off your PC. ",
