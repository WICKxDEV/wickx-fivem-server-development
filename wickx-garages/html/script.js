...
function closeGarageMenu() {
    ...
    fetch("https://wickx-garages/closeGarage", {
        method: "POST",
        headers: {
...
function populateVehicleList(garageLabel, vehicles) {
    ...
    vehicles.forEach((v) => {
        ...
        driveButton.onclick = function () {
            ...
            if (status === "Out") {
                fetch("https://wickx-garages/trackVehicle", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json; charset=UTF-8",
                    },
                ...
                fetch("https://wickx-garages/takeOutDepo", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json; charset=UTF-8",
                    },
                ...
                fetch("https://wickx-garages/takeOutVehicle", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json; charset=UTF-8",
                    },
