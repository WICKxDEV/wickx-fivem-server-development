...
ToggleNoClip = function(state)
    ...
    WKXCore.Functions.Notify(IsNoClipping and Lang:t('success.noclip_enabled') or Lang:t('success.noclip_disabled'))
...
RegisterNetEvent('wickx-admin:client:ToggleNoClip', function()
