...
RegisterNetEvent('wickx-log:server:CreateLog', function(name, title, color, message, tagEveryone, imageUrl)
    ...
    if Config.Logging == 'discord' then
        ...
        local embedData = {
            {
                ...
                ['author'] = {
                    ['name'] = 'WKXCore Logs',
                    ['icon_url'] = 'https://raw.githubusercontent.com/GhzGarage/wickx-media-kit/main/Display%20Pictures/Logo%20-%20Display%20Picture%20-%20Stylized%20-%20Red.png',
                },
        ...
        if #logQueue[name] >= 10 then
            local postData = { username = 'WKX Logs', embeds = {} }
...
WKXCore.Commands.Add('testwebhook', 'Test Your Discord Webhook For Logs (God Only)', {}, false, function()
    TriggerEvent('wickx-log:server:CreateLog', 'testwebhook', 'Test Webhook', 'default', 'Webhook setup successfully')
end, 'god')
