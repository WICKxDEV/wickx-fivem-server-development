const bankingApp = Vue.createApp({
    ...
    methods: {
        ...
        withdrawMoney() {
            ...
            axios
                .post("https://wickx-banking/withdraw", {
        ...
        depositMoney() {
            ...
            axios
                .post("https://wickx-banking/deposit", {
                    accountName: this.selectedMoneyAccount.name,
                    amount: this.selectedMoneyAmount,
                    reason: this.moneyReason,
                })
        ...
        internalTransfer() {
            ...
            axios
                .post("https://wickx-banking/internalTransfer", {
        ...
        externalTransfer() {
            ...
            axios
                .post("https://wickx-banking/externalTransfer", {
        ...
        orderDebitCard() {
            ...
            axios
                .post("https://wickx-banking/orderCard", {
                    pin: this.debitPin,
                })
                .then((response) => {
                    if (response.data.success) {
        ...
        openAccount() {
            ...
            axios
                .post("https://wickx-banking/openAccount", {
        ...
        renameAccount() {
            ...
            axios
                .post("https://wickx-banking/renameAccount", {
        ...
        deleteAccount() {
            ...
            axios
                .post("https://wickx-banking/deleteAccount", {
        ...
        addUserToAccount() {
            ...
            axios
                .post("https://wickx-banking/addUser", {
        ...
        removeUserFromAccount() {
            ...
            axios
                .post("https://wickx-banking/removeUser", {
                    accountName: this.manageAccountName.name,
                    userName: this.manageUserName,
                })
                .then((response) => {
