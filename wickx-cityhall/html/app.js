...
Close = function () {
    ...
    $.post("https://wickx-cityhall/close");
...
$(".cityhall-option-block").click(function (e) {
    ...
    if (blockPage == "identity") {
        ...
        $.post("https://wickx-cityhall/requestLicenses", JSON.stringify({}), function (licenses) {
...
$(".request-identity-button").click(function (e) {
    e.preventDefault();
    $.post(
        "https://wickx-cityhall/requestId",
        JSON.stringify({
...
$(document).on("click", ".apply-job-button", function (e) {
    e.preventDefault();
    $.post("https://wickx-cityhall/applyJob", JSON.stringify(selectedJobId));
    ResetPages();
});
