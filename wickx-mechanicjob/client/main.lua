...
local function VehicleList(shop)
    ...
    for i = 1, #list do
        ...
        vehicleMenu[#vehicleMenu + 1] = {
            header = WKXCore.Shared.Vehicles[v].name,
            params = {
                event = 'wickx-mechanicjob:client:SpawnListVehicle',
                args = {
                    spawnName = v,
...
RegisterNetEvent('wickx-mechanicjob:client:SpawnListVehicle', function(data)
...
CreateThread(function()
    for k, v in pairs(Config.Shops) do
        ...
        exports['wickx-target']:AddCircleZone(k .. '_duty', v.duty, 0.5, {
            name = k .. '_duty',
            debugPoly = false,
            useZ = true
        }, {
        ...
        exports['wickx-target']:AddCircleZone(k .. '_stash', v.stash, 0.5, {
            name = k .. '_stash',
            debugPoly = false,
            useZ = true
        }, {
            options = { {
                ...
                job = v.managed and k or nil,
                type = 'server',
                event = 'wickx-mechanicjob:server:stash',
            } },
            distance = 2.0
        })

        exports['wickx-target']:AddCircleZone(k .. '_paintbooth', v.paint, 0.5, {
            name = k .. '_paintbooth',
            debugPoly = false,
            useZ = true
        }, {
        ...
        exports['wickx-target']:AddCircleZone(k .. '_spawner', v.vehicles.withdraw, 0.5, {
            name = k .. '_spawner',
            debugPoly = false,
            useZ = true
        }, {
