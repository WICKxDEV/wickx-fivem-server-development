        ...
        while true do
            ...
            if isDriver then
                ...
                if drivingDistance[plate] then
                    TriggerServerEvent('wickx-mechanicjob:server:updateDrivingDistance', plate, drivingDistance[plate].distance)
                    TriggerServerEvent('wickx-mechanicjob:server:updateVehicleComponents', plate, vehicleComponents[plate])
                end
                plate = nil
                vehicle = nil
                break
