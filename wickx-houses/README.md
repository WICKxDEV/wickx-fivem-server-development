# wickx-houses
Real Estate for WKX-Core Framework :house_with_garden:
...
- [wickx-radialmenu](https://github.com/wickxcore-framework/wickx-radialmenu) - For the menu in screenshots
- [wickx-anticheat](https://github.com/wickxcore-framework/wickx-anticheat) - Anti Cheat 
- [wickx-phone](https://github.com/wickxcore-framework/wickx-phone) - Houses app
- [wickx-multicharacter](https://github.com/wickxcore-framework/wickx-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [wickx-garages](https://github.com/wickxcore-framework/wickx-garages) - House Garage
- [wickx-interior](https://github.com/wickxcore-framework/wickx-interior) - Necessary for house interiors
- [wickx-clothing](https://github.com/wickxcore-framework/wickx-clothing) - Outfits
- [wickx-weathersync](https://github.com/wickxcore-framework/wickx-weathersync) - Desync weather inside house
- [wickx-weed](https://github.com/wickxcore-framework/wickx-weed) - Weed plant
- [wickx-minigames](https://github.com/wickxcore-framework/wickx-minigames) - Skills
...
- Import `wickx-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure wickx-core
ensure wickx-radialmenu
ensure wickx-anticheat
ensure wickx-phone
ensure wickx-multicharacter
ensure wickx-garages
ensure wickx-interior
ensure wickx-clothing
ensure wickx-weathersync
ensure wickx-weed
ensure wickx-skillbar
```
