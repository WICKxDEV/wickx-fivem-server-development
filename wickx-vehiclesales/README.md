# wickx-vehiclesales
Used Car Sale for WKX-Core Framework :blue_car:
...
- [wickx-garages](https://github.com/wickxcore-framework/wickx-garages) - Vehicle ownership
- [wickx-phone](https://github.com/wickxcore-framework/wickx-phone) - For the e-mail
- [wickx-logs](https://github.com/wickxcore-framework/wickx-logs) - Keep event logs
...
- Import `wickx-vehiclesales.sql` in your database
...
ensure wickx-vehiclesales
```

## Configuration
- To adjust tax, go to wickx-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
