...
function closeMenu() {
    ...
    $.post("https://wickx-hud/closeMenu");
}
function restartHud() {
    closeMenu();
    $.post("https://wickx-hud/restartHud");
}
function resetStorage() {
    closeMenu();
    $.post("https://wickx-hud/resetStorage");
}
function showOutMap() {
    $.post("https://wickx-hud/showOutMap");
}
function showOutCompass() {
    $.post("https://wickx-hud/showOutCompass");
}
function showFollowCompass() {
    $.post("https://wickx-hud/showFollowCompass");
}
function openMenuSounds() {
    $.post("https://wickx-hud/openMenuSounds");
}
function resetHudSounds() {
    $.post("https://wickx-hud/resetHudSounds");
}
function checklistSounds() {
    $.post("https://wickx-hud/checklistSounds");
}
function showMapNotif() {
    $.post("https://wickx-hud/showMapNotif");
}
function showFuelAlert() {
    $.post("https://wickx-hud/showFuelAlert");
}
function showCinematicNotif() {
    $.post("https://wickx-hud/showCinematicNotif");
}
function dynamicHealth() {
    $.post("https://wickx-hud/dynamicHealth");
}
function dynamicArmor() {
    $.post("https://wickx-hud/dynamicArmor");
}
function dynamicHunger() {
    $.post("https://wickx-hud/dynamicHunger");
}
function dynamicThirst() {
    $.post("https://wickx-hud/dynamicThirst");
}
function dynamicStress() {
    $.post("https://wickx-hud/dynamicStress");
}
function dynamicOxygen() {
    $.post("https://wickx-hud/dynamicOxygen");
}
function dynamicEngine() {
    $.post("https://wickx-hud/dynamicEngine");
}
function dynamicNitro() {
    $.post("https://wickx-hud/dynamicNitro");
}
function ToggleMapShape() {
    $.post("https://wickx-hud/ToggleMapShape");
}
function changeFPS() {
    $.post("https://wickx-hud/changeFPS");
}
function ToggleMapBorders() {
    $.post("https://wickx-hud/ToggleMapBorders");
}
function HideMap() {
    $.post("https://wickx-hud/HideMap");
}
function changeCompassFPS() {
    $.post("https://wickx-hud/changeCompassFPS");
}
function showCompassBase() {
    $.post("https://wickx-hud/showCompassBase");
}
function showStreetsNames() {
    $.post("https://wickx-hud/showStreetsNames");
}
function showPointerIndex() {
    $.post("https://wickx-hud/showPointerIndex");
}
function showDegreesNum() {
    $.post("https://wickx-hud/showDegreesNum");
}
function cinematicMode() {
    $.post("https://wickx-hud/cinematicMode");
}
