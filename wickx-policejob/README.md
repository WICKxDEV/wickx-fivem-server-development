# wickx-policejob
Police Job for WKX-Core Framework :police_officer:
...
- [wickx-bossmenu](https://github.com/wickxcore-framework/wickx-bossmenu)  (Deprecated) - For the boss menu
- [wickx-management](https://github.com/wickxcore-framework/wickx-management) (Replaces wickx-bossmenu) - For the boss/gang menu
- [wickx-garages](https://github.com/wickxcore-framework/wickx-garages) - For the vehicle spawner
- [wickx-clothing](https://github.com/wickxcore-framework/wickx-clothing) - For the locker room
- [wickx-phone](https://github.com/wickxcore-framework/wickx-phone) - For the MEOS app and notifications etc.
- [wickx-log](https://github.com/wickxcore-framework/wickx-logs) - (Deprecated) - For logging certain events
- [wickx-smallresources](https://github.com/wickxcore-framework/wickx-smallresources) (Replaces wickx-log) - wickx-log was added to wickx-smallresources
- [wickx-menu](https://github.com/wickxcore-framework/wickx-menu) - For the vehicle menus
- [wickx-input](https://github.com/wickxcore-framework/wickx-input) - For accessing evidence stashes
