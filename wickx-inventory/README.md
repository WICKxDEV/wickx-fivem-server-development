...
- [wickx-smallresources](https://github.com/wickxcore-framework/wickx-smallresources) - For logging transfer and other history
...
## Documentation
https://docs.wickxcore.org/wickxcore-documentation/wickxcore-resources/wickx-inventory

## Installation
### Manual
- Download the script and put it in the `[wickx]` directory.
- Import `wickx-inventory.sql` in your database
- Add the following code to your server.cfg/resouces.cfg

# Migrating from old wickx-inventory
