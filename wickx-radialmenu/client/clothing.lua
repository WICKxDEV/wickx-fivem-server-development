...
RegisterNetEvent('wickx-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('wickx-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('wickx-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	WKXCore.Functions.Notify(message, color)
end
