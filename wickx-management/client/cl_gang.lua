...
local PlayerGang = WKXCore.Functions.GetPlayerData().gang
...
AddEventHandler('onResourceStart', function(resource) --if you restart the resource
    if resource == GetCurrentResourceName() then
        Wait(200)
        PlayerGang = WKXCore.Functions.GetPlayerData().gang
    end
end)
...
RegisterNetEvent('WKXCore:Client:OnGangUpdate', function(InfoGang)
    PlayerGang = InfoGang
end)

RegisterNetEvent('wickx-gangmenu:client:Warbobe', function()
...
RegisterNetEvent('wickx-gangmenu:client:OpenMenu', function()
    shownGangMenu = true
    local gangMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = 'wickx-gangmenu:client:ManageGang',
            }
        },
        {
            ...
            params = {
                event = 'wickx-gangmenu:client:HireMembers',
            }
        },
        {
            ...
            params = {
                isServer = true,
                event = 'wickx-gangmenu:server:stash',
            }
        },
        {
            ...
            params = {
                event = 'wickx-gangmenu:client:Warbobe',
            }
        }
    }
    ...
    exports['wickx-menu']:openMenu(gangMenu)
end)

RegisterNetEvent('wickx-gangmenu:client:ManageGang', function()
    ...
    WKXCore.Functions.TriggerCallback('wickx-gangmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            GangMembersMenu[#GangMembersMenu + 1] = {
                ...
                params = {
                    event = 'wickx-gangmenu:lient:ManageMember',
                    args = {
                        player = v,
                        work = PlayerGang
                    }
        ...
        GangMembersMenu[#GangMembersMenu + 1] = {
            ...
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'wickx-gangmenu:client:OpenMenu',
            }
        }
        exports['wickx-menu']:openMenu(GangMembersMenu)
    end, PlayerGang.name)
end)

RegisterNetEvent('wickx-gangmenu:lient:ManageMember', function(data)
    local MemberMenu = {
        {
    ...
    for k, v in pairs(WKXCore.Shared.Gangs[data.work.name].grades) do
        MemberMenu[#MemberMenu + 1] = {
            header = v.name,
            txt = Lang:t('bodygang.grade') .. k,
            params = {
                isServer = true,
                event = 'wickx-gangmenu:server:GradeUpdate',
    ...
    MemberMenu[#MemberMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = 'wickx-gangmenu:server:FireMember',
    ...
    exports['wickx-menu']:openMenu(MemberMenu)
end)

RegisterNetEvent('wickx-gangmenu:client:HireMembers', function()
    ...
    WKXCore.Functions.TriggerCallback('wickx-gangmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMembersMenu[#HireMembersMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = 'wickx-gangmenu:server:HireMember',
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['wickx-menu']:openMenu(HireMembersMenu)
    end)
end)
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownGangMenu then
                                        exports['wickx-core']:DrawText(Lang:t('drawtextgang.label'), 'left')
                                        shownGangMenu = true
                                    end

                                    if IsControlJustReleased(0, 38) then
                                        exports['wickx-core']:HideText()
                                        TriggerEvent('wickx-gangmenu:client:OpenMenu')
                                    end
                                end
