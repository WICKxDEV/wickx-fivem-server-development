...
WKXShared.Vehicles = WKXShared.Vehicles or {}
...
WKXShared.VehicleHashes = WKXShared.VehicleHashes or {}
for i = 1, #Vehicles do
    local hash = joaat(Vehicles[i].model)
    WKXShared.Vehicles[Vehicles[i].model] = {
    ...
    WKXShared.VehicleHashes[hash] = WKXShared.Vehicles[Vehicles[i].model]
end
