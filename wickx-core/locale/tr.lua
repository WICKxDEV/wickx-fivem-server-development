local Translations = {
    error = {
        ...
        duplicate_license           = '[WKXCORE] - Aynı Rockstar Lisansı Bulundu',
        no_valid_license            = '[WKXCORE] - Geçerli Rockstar Lisansı Bulunamadı',
        not_whitelisted             = '[WKXCORE] - Bu sunucu için beyaz listedesiniz',
        ...
        ban_table_not_found         = '[WKXCORE] - Veritabanında yasaklılar tablosu bulunamadı. Lütfen SQL dosyasının doğru şekilde yüklendiğinden emin olun.',
        connecting_database_error   = '[WKXCORE] - Veritabanına bağlanırken hata oluştu. SQL sunucusunun çalıştığından ve server.cfg dosyasındaki bilgilerin doğru olduğundan emin olun.',
        connecting_database_timeout = '[WKXCORE] - Veritabanı bağlantısı zaman aşımına uğradı. SQL sunucusunun çalıştığından ve server.cfg dosyasındaki bilgilerin doğru olduğundan emin olun.',
    },
    success = {
...
if GetConvar('WKX_locale', 'en') == 'tr' then
    Lang = Locale:new({
