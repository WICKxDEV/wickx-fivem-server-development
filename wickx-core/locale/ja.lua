local Translations = {
    error = {
        ...
        duplicate_license           = '[WKXCORE] - Rockstarライセンスが重複しています',
        no_valid_license            = '[WKXCORE] - 有効なRockstarライセンスが見つかりません',
        not_whitelisted             = '[WKXCORE] - あなたはホワイトリストに登録されていません',
        ...
        connecting_database_error   = '[WKXCORE] - サーバーへの接続中にデータベースエラーが発生しました(SQLサーバの稼働を確認してください)',
        connecting_database_timeout = '[WKXCORE] - データベースへの接続がタイムアウトしました(SQLサーバーの稼働を確認してください)',
    },
    success = {
...
if GetConvar('WKX_locale', 'en') == 'ja' then
    Lang = Locale:new({
