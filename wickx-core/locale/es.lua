local Translations = {
    error = {
        ...
        connecting_database_error   = '[WKXCORE] - Un error en la base de datos sucedió mientras te conectabas al servidor (¿Está la SQL del servidor encendida?)',
        connecting_database_timeout = '[WKXCORE] - La conexión con la base de datos falló (¿Está la SQL del servidor encendida?)',
    },
    success = {
...
if GetConvar('WKX_locale', 'en') == 'es' then
    Lang = Locale:new({
