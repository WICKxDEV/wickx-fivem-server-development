local Translations = {
    error = {
        ...
        duplicate_license           = '[WKXCORE] - Duplicate Rockstar License Found',
        no_valid_license            = '[WKXCORE] - No Valid Rockstar License Found',
        not_whitelisted             = '[WKXCORE] - You\'re not whitelisted for this server',
        ...
        ban_table_not_found         = '[WKXCORE] - Unable to find the bans table in the database. Please ensure you have imported the SQL file correctly.',
        connecting_database_error   = '[WKXCORE] - An error occurred while connecting to the database. Ensure that the SQL server is running and that the details in the server.cfg file are correct.',
        connecting_database_timeout = '[WKXCORE] - The database connection has timed out. Ensure that the SQL server is running and that the details in the server.cfg file are correct.',
    },
    success = {
