# wickx-apartments
Apartments System for WKX-Core Framework :office:
...
- [wickx-clothing](https://github.com/wickxcore-framework/wickx-clothing) - To save outfits
- [wickx-houses](https://github.com/wickxcore-framework/wickx-houses) - House logic
- [wickx-interior](https://github.com/wickxcore-framework/wickx-interior) - Interior logic
- [wickx-weathersync](https://github.com/wickxcore-framework/wickx-weathersync) - To desync weather while inside
- [wickx-spawn](https://github.com/wickxcore-framework/wickx-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `wickx-apartments.sql` in your database
