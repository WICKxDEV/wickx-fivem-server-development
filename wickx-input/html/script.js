...
const OpenMenu = (data) => {
    ...
    let form = ["<form id='wickx-input-form'>", `<div class="heading">${data.header != null ? data.header : "Form Title"}</div>`];
    ...
    $("#wickx-input-form").on("change", function (event) {
    ...
    $("#wickx-input-form").on("submit", async function (event) {
        if (event != null) {
