...
$(document).on('click', '.phone-app-footer-button', function(e){
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        if (PressedFooterTab == "recent") {
            $.post('https://wickx-phone/ClearRecentAlerts');
...
WKX.Phone.Functions.SetupRecentCalls = function(recentcalls) {
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('https://wickx-phone/CallContact', JSON.stringify({
        ContactData: cData,
        Anonymous: WKX.Phone.Data.AnonymousCall,
    }), function(status){
        if (cData.number !== WKX.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (WKX.Phone.Data.AnonymousCall) {
                            WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "You started a anonymous call!");
                        }
                        $(".phone-call-outgoing").css({"display":"block"});
                        $(".phone-call-incoming").css({"display":"none"});
                        $(".phone-call-ongoing").css({"display":"none"});
                        $(".phone-call-outgoing-caller").html(cData.name);
                        WKX.Phone.Functions.HeaderTextColor("white", 400);
                        WKX.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
                        setTimeout(function(){
                            $(".phone-app").css({"display":"none"});
                            WKX.Phone.Animations.TopSlideDown('.phone-application-container', 400, 0);
                            WKX.Phone.Functions.ToggleApp("phone-call", "block");
                        }, 450);

                        CallData.name = cData.name;
                        CallData.number = cData.number;

                        WKX.Phone.Data.currentApplication = "phone-call";
                    } else {
                        WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "You're already in a call!");
                    }
                } else {
                    WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is busy!");
                }
            } else {
                WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call yourself!");
        }
    });
});
...
WKX.Phone.Functions.LoadContacts = function(myContacts) {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== WKX.Phone.Data.PlayerData.charinfo.phone) {
        ...
        setTimeout(function(){
            ...
            WKX.Phone.Functions.ToggleApp("phone", "none");
            WKX.Phone.Functions.ToggleApp("whatsapp", "block");
            WKX.Phone.Data.currentApplication = "whatsapp";

            $.post('https://wickx-phone/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
                WKX.Phone.Functions.SetupChatMessages(chat, {
        ...
        WKX.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "You can't whatsapp yourself..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    WKX.Phone.Animations.TopSlideDown(".phone-edit-contact", 200, 0);
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://wickx-phone/EditContact', JSON.stringify({
            ...
            WKX.Phone.Functions.LoadContacts(PhoneContacts);
        });
        WKX.Phone.Animations.TopSlideUp(".phone-edit-contact", 250, -100);
        setTimeout(function(){
            $(".phone-edit-contact-number").val("");
            $(".phone-edit-contact-name").val("");
        }, 250)
    } else {
        WKX.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "Fill out all fields!");
    }
});
...
$(document).on('click', '#edit-contact-delete', function(e){
    ...
    $.post('https://wickx-phone/DeleteContact', JSON.stringify({
        CurrentContactName: ContactName,
        CurrentContactNumber: ContactNumber,
        CurrentContactIban: ContactIban,
    }), function(PhoneContacts){
...
$(document).on('click', '#phone-plus-icon', function(e){
    ...
    WKX.Phone.Animations.TopSlideDown(".phone-add-contact", 200, 0);
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://wickx-phone/AddNewContact', JSON.stringify({
        ...
        WKX.Phone.Animations.TopSlideUp(".phone-add-contact", 250, -100);
        setTimeout(function(){
        ...
        if (SelectedSuggestion !== null) {
            $.post('https://wickx-phone/RemoveSuggestion', JSON.stringify({
        ...
        WKX.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "Fill out all fields!");
    }
});
        ...
        if (cData.number !== WKX.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is in a call!");
                }
            } else {
                WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            WKX.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call your own number!");
        }
    });
}

CancelOutgoingCall = function() {
    if (WKX.Phone.Data.currentApplication == "phone-call") {
        WKX.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
...
$(document).on('click', '#outgoing-cancel', function(e){
    ...
    $.post('https://wickx-phone/CancelOutgoingCall');
});

$(document).on('click', '#incoming-deny', function(e){
    e.preventDefault();

    $.post('https://wickx-phone/DenyIncomingCall');
});

$(document).on('click', '#ongoing-cancel', function(e){
    e.preventDefault();

    $.post('https://wickx-phone/CancelOngoingCall');
});

IncomingCallAlert = function(CallData, Canceled, AnonymousCall) {
    if (!Canceled) {
        if (!WKX.Phone.Data.CallActive) {
            WKX.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
            WKX.Phone.Animations.TopSlideUp('.'+WKX.Phone.Data.currentApplication+"-app", 400, -160);
            setTimeout(function(){
                ...
                $(".phone-app").css({"display":"none"});
                WKX.Phone.Functions.HeaderTextColor("white", 400);
                $("."+WKX.Phone.Data.currentApplication+"-app").css({"display":"none"});
            ...
            WKX.Phone.Data.currentApplication = "phone-call";
            WKX.Phone.Data.CallActive = true;
        }
        setTimeout(function(){
...
WKX.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        CallData = cData;
...
$(document).on('click', '.phone-currentcall-container', function(e){
    ...
    WKX.Phone.Functions.HeaderTextColor("white", 500);
    WKX.Phone.Animations.TopSlideDown('.phone-application-container', 500, 0);
    WKX.Phone.Animations.TopSlideDown('.phone-call-app', 500, 0);
    WKX.Phone.Functions.ToggleApp("phone-call", "block");
...
$(document).on('click', '#incoming-answer', function(e){
    ...
    $.post('https://wickx-phone/AnswerCall');
});

WKX.Phone.Functions.AnswerCall = function(CallData) {
    $(".phone-call-incoming").css({"display":"none"});
    $(".phone-call-outgoing").css({"display":"none"});
    $(".phone-call-ongoing").css({"display":"block"});
...
WKX.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
