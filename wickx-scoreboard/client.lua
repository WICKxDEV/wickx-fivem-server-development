...
RegisterNetEvent('wickx-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            WKXCore.Functions.TriggerCallback('wickx-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
